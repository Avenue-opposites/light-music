<template>
    <svg v-if="active" xmlns="http://www.w3.org/2000/svg" :width="$props.size" :height="$props.size" :color="$props.color"
        fill="currentColor" class="bi bi-cloudy-fill icon" viewBox="0 0 16 16">
    ...
    <svg v-else xmlns="http://www.w3.org/2000/svg" :width="$props.size" :height="$props.size" :color="$props.color"
        fill="currentColor" class="bi bi-cloudy icon" viewBox="0 0 16 16">
        <path
